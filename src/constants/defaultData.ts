...
export const INITIAL_ADMINS: AdminUser[] = [
  ...
  {
    id: 'adm-002',
    email: 'rh.coari@empresa.com.br',
    nome: 'Coordenação de RH Regional',
    cargo: 'Coordenadora de Recursos Humanos',
    nivelAcesso: 'GESTOR_RH',
    ativo: true,
    criadoEm: '2025-01-01 08:00:00',
  },
  {
    id: 'adm-003',
    email: 'auditoria.sptf@empresa.com.br',
    nome: 'Auditoria Trabalhista & Compliance',
    cargo: 'Auditor Externo',
    nivelAcesso: 'AUDITOR',
    ativo: true,
    criadoEm: '2025-02-01 10:00:00',
  },
];
